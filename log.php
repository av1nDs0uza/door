              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">View All Logs</h4>
                  </div>
...
<?php
                 $query = "SELECT * FROM `in_logs` WHERE 1";
                 $result = mysqli_query($link,$query);

                  while( $row3 = mysqli_fetch_assoc( $result ) )
                      {
                        
                        $time = date('Y-m-d H:i:s', $row3['time']);
                        
                        echo"<tr><td>{$row3['fin_id']}</td>";
    ...
    <div class="btn-group m-r-12">
      <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light" type="button">Options <span class="caret"></span></button>
       ...
       <ul role="menu" class="dropdown-menu">    
        ...
        <li><a href="delete_log.php?id=<?php echo $row3['id'];?>">Delete</a>

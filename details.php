...
<form align="Left"  method="post" action="dashboard.php">
	<input type="hidden" name="table" value="1"><br>
	<button type="submit" class="button" ><span>Back</span> </button><br>
 </form>
...
<table>
            ...
            $select_path="SELECT * FROM `sensordata` WHERE p_id = '$p_id'";

  ...
  <div id="page-wrapper">
   ...
   <form class="form-material form-horizontal" action="add_back.php" method="POST" enctype="multipart/form-data" onsubmit="validateform()" >
      ...
      <div class="form-group">
            <div class="col-md-2">
            <label for="event_title">Uset ID<span class="text-danger">*</span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="first_name" name="id"  placeholder="Entre ID" maxlength="20"  ><br>
                </div>
      </div>
	  ...
	  <div class="form-group">
            ...
            <label for="event_title">Name<span class="text-danger"></span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="first_name" name="name"   maxlength="20"  ><br>
			    </div>
      </div>

      <div class="form-group">
            <div class="col-md-2">
            <label for="event_title">Number<span class="text-danger"></span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="first_name" name="number"  maxlength="20"  ><br>
                </div>
      </div>
          ...
          <div class="form-group">
            ...
            <label for="event_title">Email<span class="text-danger"></span></label></div>
                <div class="col-md-3">
                   <input type="text" class="form-control" id="first_name" name="email"  maxlength="20"  ><br>
                </div>
      </div>
